...
class Edit extends Component
{
    ...
    public function mount(OverallObservationTemplate $overallObservationTemplate)
    {
        ...
        $this->detailed_observation_1 = $this->overallObservationTemplate->detailed_observation_1;
        $this->detailed_observation_2 = $this->overallObservationTemplate->detailed_observation_2;
        $this->detailed_observation_3 = $this->overallObservationTemplate->detailed_observation_3;
        $this->detailed_observation_4 = $this->overallObservationTemplate->detailed_observation_4;
        $this->detailed_observation_5 = $this->overallObservationTemplate->detailed_observation_5;
        $this->detailed_observation_6 = $this->overallObservationTemplate->detailed_observation_6;

        $this->class                      = $this->overallObservationTemplate->class()->pluck('id')->toArray();
        $this->stream_group               = $this->overallObservationTemplate->streamGroup()->pluck('id')->toArray();
        $this->stream                     = $this->overallObservationTemplate->stream()->pluck('id')->toArray();
        $this->course                     = $this->overallObservationTemplate->course()->pluck('id')->toArray();
        $this->college                    = $this->overallObservationTemplate->college()->pluck('id')->toArray();
        $this->profession                 = $this->overallObservationTemplate->profession()->pluck('id')->toArray();
        $this->initListsForFields();
    }

    public function render()
    {
        return view('livewire.overall-observation-template.edit');
    }
