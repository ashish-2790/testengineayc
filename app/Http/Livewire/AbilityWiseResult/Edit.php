...
class Edit extends Component
{
    ...
    public function mount(AbilityWiseResult $abilityWiseResult)
    {
        ...
        $this->report_1 = $abilityWiseResult->report_1;
        $this->report_2 = $abilityWiseResult->report_2;
        $this->report_3 = $abilityWiseResult->report_3;
        $this->report_4 = $abilityWiseResult->report_4;
        $this->report_5 = $abilityWiseResult->report_5;
        $this->report_6 = $abilityWiseResult->report_6;
    ...
    {
        return view('livewire.ability-wise-result.edit');
    }
