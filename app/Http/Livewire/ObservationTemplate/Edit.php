...
class Edit extends Component
{
    ...
    public function mount(ObservationTemplate $observationTemplate)
    {
        ...
        $this->observation_1       = $this->observationTemplate->observation_1;
        $this->observation_2       = $this->observationTemplate->observation_2;
        $this->observation_3       = $this->observationTemplate->observation_3;
        $this->observation_4       = $this->observationTemplate->observation_4;
        $this->observation_5       = $this->observationTemplate->observation_5;
        $this->observation_6       = $this->observationTemplate->observation_6;

        $this->stream_group        = $this->observationTemplate->streamGroup()->pluck('id')->toArray();
        $this->stream              = $this->observationTemplate->stream()->pluck('id')->toArray();
        $this->course              = $this->observationTemplate->course()->pluck('id')->toArray();
        $this->college             = $this->observationTemplate->college()->pluck('id')->toArray();
        $this->profession          = $this->observationTemplate->profession()->pluck('id')->toArray();
        $this->initListsForFields();
    }

    public function render()
    {
        return view('livewire.observation-template.edit');
    }
