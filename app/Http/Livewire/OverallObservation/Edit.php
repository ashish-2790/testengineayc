...
class Edit extends Component
{
    ...
    public function mount(OverallObservation $overallObservation)
    {
        ...
        $this->observation_1       = $this->overallObservation->observation_1;
        $this->observation_2       = $this->overallObservation->observation_2;
        $this->observation_3       = $this->overallObservation->observation_3;
        $this->observation_4       = $this->overallObservation->observation_4;
        $this->observation_5       = $this->overallObservation->observation_5;
        $this->observation_6       = $this->overallObservation->observation_6;

        $this->stream_group       = $this->overallObservation->streamGroup()->pluck('id')->toArray();
        $this->stream             = $this->overallObservation->stream()->pluck('id')->toArray();
        $this->college            = $this->overallObservation->college()->pluck('id')->toArray();
        $this->courses            = $this->overallObservation->courses()->pluck('id')->toArray();
        $this->profession         = $this->overallObservation->profession()->pluck('id')->toArray();
        $this->initListsForFields();
    }

    public function render()
    {
        return view('livewire.overall-observation.edit');
    }
