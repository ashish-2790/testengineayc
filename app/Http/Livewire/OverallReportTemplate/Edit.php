...
class Edit extends Component
{
    ...
    public function mount(OverallReportTemplate $overallReportTemplate)
    {
        ...
        $this->class                 = $this->overallReportTemplate->class()->pluck('id')->toArray();
        $this->detailed_report_1     = $this->overallReportTemplate->detailed_report_1;
        $this->detailed_report_2     = $this->overallReportTemplate->detailed_report_2;
        $this->detailed_report_3     = $this->overallReportTemplate->detailed_report_3;
        $this->detailed_report_4     = $this->overallReportTemplate->detailed_report_4;
        $this->detailed_report_5     = $this->overallReportTemplate->detailed_report_5;
        $this->detailed_report_6     = $this->overallReportTemplate->detailed_report_6;
    ...
    {
        return view('livewire.overall-report-template.edit');
    }
