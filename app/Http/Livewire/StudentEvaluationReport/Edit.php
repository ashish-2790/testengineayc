...
class Edit extends Component
{
    ...
    public function mount(StudentEvaluationReport $studentEvaluationReport)
    {
        ...
        $this->related_college         = $this->studentEvaluationReport->relatedCollege()->pluck('id')->toArray();
        $this->related_stream          = $this->studentEvaluationReport->relatedStream()->pluck('id')->toArray();
        $this->related_profession      = $this->studentEvaluationReport->relatedProfession()->pluck('id')->toArray();
        $this->initListsForFields();
    }

    public function render()
    {
        return view('livewire.student-evaluation-report.edit');
    }
