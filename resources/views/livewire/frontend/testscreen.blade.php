                        ...
                        @if($question_text)
                                ...
                                <div>
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio"
                                               value="{{ $SampleQuestionDisplay->choice_1??''}}"
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio"
                                               value=" {{ $SampleQuestionDisplay->choice_2??''}}"
                                               wire:model.defer='answer' name="answer" id="answer">
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio"
                                               value=" {{ $SampleQuestionDisplay->choice_3??''}}"
                                               wire:model.defer='answer' name="answer" id="answer">
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio"
                                               value=" {{ $SampleQuestionDisplay->choice_4??''}}"
                                               wire:model.defer='answer' name="answer" id="answer">
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio"
                                               value=" {{ $SampleQuestionDisplay->choice_5??''}}"
                                               wire:model.defer='answer' name="answer" id="answer">
                                        <label class="form-check-label mt-1" for="flexRadioDefault4">
                                    ...
                                    <div class="card-footer mt-2 h-lg-40 p-2">
                                        @if($SampleQuestionDisplay->id==$lastSampleQuestion->id)
                                            <button class="btn btn-sm p-2 btn-danger text-white button float-end finish  ps-5 pe-5 mb-1 mt-1"
                                                    wire:click="sampleQuestionsOver({{$question_text->udf_2}},{{$SampleQuestionDisplay}})">
                                                Next & Start Test
                                            </button>
                                        @else
                                            <button class="btn btn-sm p-2 btn-success text-white button float-end finish  ps-5 pe-5 mb-1 mt-1"
                                                    wire:click="nextStep({{$question_text->udf_2}},{{$SampleQuestionDisplay}})">
                                                Next
                                            </button>
                                        @endif
                                    </div>
                            ...
                            @else
                                <div class="card-body p-2 pb-2">
                                    ...
                                    @if($question_text->relatedQuestionBank->choice_4)
                                        <div class="form-check">
                                            <input class="form-check-input" required type="radio"
                                    ...
                                    @endif
                                    @if($question_text->relatedQuestionBank->choice_5)
                                        <div class="form-check">
                                            <input class="form-check-input" required type="radio"
                            ...
                            @else
                                <div class="card card-progress p-0 m-0 h-1/2 overflow-auto">
                                    @foreach($allQuestionsList->groupBy("relatedAbility.ability_name") as $ability_name => $ability_name_items)
                                        ...
                                        <div>
                                            <button class="d-block text-xs bg-transparent text-dark ps-2 m-0"
                                                    wire:click="instructionsReplay({{$ability_name_items->first()->udf_2}})">{{ $ability_name }}</button>
                                            <div class="progress">
                                                        ...
                                                        <div class="d-flex-wrap-wrap pb-1">
                                                            ...
                                                            @foreach($ability_name_items as $question)
                                                                @php
                                                                    ...
                                                                    $bounceeffect='';
                                                                @endphp
                                                                <button wire:click="showSpecificquestion({{$question->related_question_bank_id}})"
                                                                        class=" {{$bounceeffect}}
                                                                        @if($question->answer_status == 3) bg-success rounded-top-circle
                                                                @elseif($question->answer_status == 4) bg-primary rounded-bottom-circle
                                                                 @elseif($question->answer_status == 2) bg-warning
