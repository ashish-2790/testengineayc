<div x-data="setup()">
    <div class="container-fluid pb-12">
        <div class="row mb-5">
            <div class="col-lg-9 col-sm-12 mb-6">
                <div class="card shadow-0 bg-gray-100">
                    ...
                    <div x-show="!instructionComplete" class="p-5">
                        <div class=" justify-content-between">
                            <h4>Instructions:</h4>
                            <h6 class="pt-3">{!! $get_ability_instruction !!}</h6>
                            <button class="btn btn-primary pt-5" @click="instructionComplete = true">Show Sample
                            </button>
                        </div>
                    ...
                    <div x-show="instructionComplete && showQuestion" class="p-5">
                        ...
                        @if($question_text)
                            ...
                            <div class="card-footer mt-5 p-2">
                                ...
                                <button class="btn btn-sm p-2 bg-blue-100 button float-end finish  ps-5 pe-5 mb-1 mt-1"
                                        type="submit"
            ...
            <div class="col-lg-3 col-sm-12">
                <div class="card p-0 bg-gray-100">
                    <div class="panel-body">
                        ...
                        <div class="bg-blue-100 p-0 pt-1">
                            ...
                            <div class="panel-body">
                                <ul class="legends ps-3">
                                    <li class="palette answered text-sm align-middle lh-loose"><span id="palette_total_answered "
                                                                               class="bg-danger rounded-10">0</span>Pending
                                    </li>
                                    <li class="palette marked text-sm align-middle lh-loose"><span id="palette_total_marked"
                                                                             class="bg-primary rounded-bottom-circle">0</span>
                                        <p class="d-flex lh-tighter">Answered & Marked for Preview</p>
                                    </li>
                                    <li class="palette not-answered text-sm align-middle lh-loose"><span id="palette_total_not_answered"
                                                                                   class="bg-success rounded-top-circle">0</span>Answered
                                    </li>
                                    <li class="palette not-visited text-sm align-middle lh-loose"><span id="palette_total_not_visited"
                                                                                  class="bg-warning ">11</span> <p class="d-flex lh-tighter">Marked for
                                            Preview</p>
                                    </li>
                                </ul>
                            </div>
                            <h5 class="float-start ms-5">ER section Question Palette:</h5>
                            <ul class="question-palette ps-3 w-full" id="pallete_list" style="height: 200px; overflow: auto;">
                                @php
                                    $i = 1;
                                @endphp
