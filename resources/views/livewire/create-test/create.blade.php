...
{{--    </div>--}}
    ...
    <div class="row m-0 g-5  flex">
      ...
      @if($enable_duration == 0)
        <div class="form-group w-full lg:w-6/12 px-4">
            <label class="form-label " for="video_url">Enable Duration</label>
            <input class="form-cotrol" type="checkbox" name="enable_duration" id="enable_duration" wire:model="enable_duration">
        </div>
        @endif
        @if($enable_duration == 1)
        <div class="form-group w-full lg:w-6/12 px-4">
