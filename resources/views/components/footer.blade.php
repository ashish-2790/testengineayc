        ...
        <div class="flex flex-wrap items-center md:justify-between justify-center">
            <div class="w-full md:w-4/12 px-4">
                <div class="text-sm text-blueGray-500 font-semibold py-1 text-center md:text-left">
                   ...
                   <a href="" class="text-blueGray-500 hover:text-blueGray-700 text-sm font-semibold py-1" target="_blank"></a> Powered by
                    <a href="https://www.iqwing.in" class="text-blueGray-500 hover:text-blueGray-700 text-sm font-semibold py-1" target="_blank">
                    IQwing
                    </a>
                </div>
            </div>
